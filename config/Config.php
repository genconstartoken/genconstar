...
// public function wallet_exits($tblname, $condition, $op='AND'){
...
// 		$wallet = "SELECT * FROM $tblname WHERE $field_var";
// 		$wallet_fire = mysqli_query($this->con, $wallet);
// 		if(mysqli_num_rows($wallet_fire) > 0){
// 			return false;
// 		}
// 		else{
// 			return true;
